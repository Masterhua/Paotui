<template>
    <div style="backgroundImage: url('/xiaoyuanfuwupingtai/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">校园跑腿注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="接单员姓名" class="input" v-if="tableName=='jiedanyuan'">
                            <el-input v-model="ruleForm.jiedanyuanName" autocomplete="off" placeholder="接单员姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='jiedanyuan'">
                            <el-input v-model="ruleForm.jiedanyuanPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='jiedanyuan'">
                            <el-input v-model="ruleForm.jiedanyuanEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.jiedanyuanName)&& 'jiedanyuan'==this.tableName){
                                this.$message.error('接单员姓名不能为空');
                                return
                            }
                             if('jiedanyuan' == this.tableName && this.ruleForm.jiedanyuanPhone&&(!this.$validate.isMobile(this.ruleForm.jiedanyuanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('jiedanyuan' == this.tableName && this.ruleForm.jiedanyuanEmail&&(!this.$validate.isEmail(this.ruleForm.jiedanyuanEmail))){
